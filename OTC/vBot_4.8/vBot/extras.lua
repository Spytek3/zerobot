...
addCheckBox("screenOnDeath", "ScreenShot on Death", true, rightPanel, "Auto printscreen when dies, saves png on appdata/otclient/screenshots")
if true then
  function screenOnDeath()
  ...
  onTextMessage(function(mode, text)
    if not settings.screenOnDeath then return end
